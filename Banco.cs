                            ...
                            using (SqlDataReader tabela = comando.ExecuteReader())
                            {
                                ...
                                while(tabela.Read())
                                {
                                    lista.Add(new Clientes()
                                    {
                                        ...
                                        valor = Convert.ToSingle(tabela["valor"] ?? 0),
                                        valor_imposto = Convert.ToSingle(tabela["valor_imposto"] ?? 0),
                                        total = Convert.ToSingle(tabela["total"] ?? 0)
